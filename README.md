...
- **Network Security** — traffic analysis, IDS/IPS, packet inspection
- **Cloud Security** — securing modern cloud-based environments
...
*Documented lab work and projects will appear here as I complete them.*
